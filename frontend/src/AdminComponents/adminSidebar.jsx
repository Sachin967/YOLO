...
const Navbar = () => {
	...
	const menuItems = [
		{ icon: <TbTruckDelivery size={25} className="mr-4" />, text: "Users",link:"/admin" },
	...
	return (
		<div className="max-w-[1640px] bg-indigo-900 mx-auto flex justify-between items-center p-4 shadow-sm">
			{/* Left side */}
			...
			<div className="bg-gray-500 rounded-full flex items-center px-2 w-[200px] sm:w-[400px] lg:w-[500px]">
				...
				<input className="bg-transparent rounded-xl p-2 w-full" type="text" placeholder="" />
			</div>
			{/* Cart button */}
			...
			<div
				className={
					nav
						? "fixed top-0 left-0 w-[300px] h-screen bg-indigo-900 z-10 duration-300"
